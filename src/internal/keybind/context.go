...
func InitContexts() {
	...
	travelKeymap.NewKeyBinding(End, false)
	...
	chatKeymap.NewKeyBinding(NextPage, true)
	chatKeymap.SetHelpDesc(NextPage, lokyn.L("scroll down"))
	chatKeymap.NewKeyBinding(PrevPage, true)
	...
	ManualKeymap.NewKeyBinding(PrevPage, true)
	ManualKeymap.NewKeyBinding(NextPage, true)
	ManualKeymap.NewKeyBinding(Home, true)
	ManualKeymap.NewKeyBinding(End, true)
	ManualKeymap.NewKeyBinding(Esc, true)
	ManualKeymap.NewKeyBinding(Quit, true)
